...
//           <h1 className="text-2xl font-semibold mb-4 text-uppercase">
//             {props.ownerName}
//           </h1>
//           <p className="leading-6 text-center">{props.content}</p>
//         </div>
...
//             </li>
//           </ul>
//           <h6 className="flex items-center text-sm mt-4">
//             <i className="fa fa-envelope-o mr-3 text-lg"></i>
//             <span>narendratomar4583@gmail.com</span>
//           </h6>
//           <h6 className="flex items-center text-sm mt-2">
...
//       <h6 className="text-center text-sm mb-4">{currDate}</h6>
//       <p className="text-center text-sm text-gray-400 mb-6 uppercase">
//         Copyright© {new Date().getFullYear()}. Made by 🤍
//         <button
//           className="text-lightblue-500 underline ml-2"
