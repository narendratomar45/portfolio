...
//       <h1
//         className="aboutme text-center mb-20 text-4xl font-semibold text-gray-800"
...
//       </p>
//       <div className="mainabout flex flex-col lg:flex-row justify-center">
//         <div
//           className="matterabout w-full lg:w-1/2 p-6 shadow-md rounded-lg bg-white"
//           data-aos="zoom-in-down"
//         >
//           <h1 className="text-3xl font-semibold text-gray-800 mb-6">Get to know me!</h1>
//           <p className="text-lg text-gray-700 leading-relaxed text-justify mb-6">
//             I'm a <strong>Frontend Developer</strong> at <strong>Namrata Universal</strong> building the Front-end of Websites and Web Applications that lead to the success of the overall product. Check out some of my work in the Projects section.
//             <br />
//             <br />
...
//             <br />
//             <br />
//             I'm open to <strong>Job</strong> opportunities where I can contribute, learn, and grow. If you have a good opportunity that matches my skills and experience, feel free to reach out.
//           </p>
//           <button className="btn-contact bg-blue-500 hover:bg-blue-600 text-white py-2 px-6 rounded-md transition duration-300">
