...
//   return (
//     <div className="text-center py-16" id="contact">
//       <h1
...
//         <div
//           className="w-1/2 max-w-sm p-4 shadow-lg rounded-lg"
//           data-aos="flip-left"
//         >
//           <img src={props.imgsrc} alt="techimg" className="w-full h-auto rounded-lg" />
//         </div>
//         <div className="w-full max-w-md p-6 bg-white shadow-md rounded-lg" data-aos="flip-up">
